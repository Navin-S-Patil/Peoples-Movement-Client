...
const mockBlogs = Array(20)
  ...
  .map((_, index) => ({
    ...
    author: "John Doe",
    publishDate: new Date(2024, 10, 13 - index).toISOString(),
    tags: ["Technology", "News", "Features"],
    coverImage: {
      imageId: `img-${index + 1}`,
      signedUrl: "/api/placeholder/400/250",
    },
    status: "published",
    lastUpdated: new Date(2024, 10, 13 - index).toISOString(),
  }));
